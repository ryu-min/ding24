...
describe('Game session testing', function() {
  it('Move works', () => {
    ...
    expect(session.getPosition())
        .toBe('rnbqkbnr/pppppppp/8/8/8/7P/PPPPPPP1/RNBQKBNR b KQkq - 0 1');
  });
  ...
  it('Undo move works in a history with 3 moves', () => {
    ...
    expect(session.getPosition())
        .toBe('rnbqkbnr/pppppppp/8/8/8/4P3/PPPP1PPP/RNBQKBNR b KQkq - 0 1');
  });
  ...
  it('Redo works in a history with 3 moves', () => {
    ...
    expect(session.getPosition())
        .toBe('rnbqkbnr/pp1ppppp/8/2p5/8/4P3/PPPP1PPP/RNBQKBNR w KQkq c6 0 2');
  });
